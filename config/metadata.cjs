...
module.exports = {
  ...
  match: ["*://app.hhaexchange.com/", "*://app.hhaexchange.com/*", "*://reports.hhaexchange.com/*", "*://mt3.1voicetech.com/webapp/*", "*://outlook.office.com/*", "*://outlook.office.com/mail/*", "https://outlook.office.com/mail/*", "*://*.office.com/*", "*://outlook.cloud.microsoft/*", "https://outlook.cloud.microsoft/*"],
  require: [
    // 使用具体版本号确保兼容性
  ...
  connect: ["app.hhaexchange.com", "reports.hhaexchange.com", "outlook.office.com", "outlook.cloud.microsoft", "unpkg.com"],
