...
module.exports = {
  ...
  match: ["*://app.hhaexchange.com/", "*://app.hhaexchange.com/*", "*://reports.hhaexchange.com/*", "*://mt3.1voicetech.com/webapp/*", "*://outlook.office.com/*", "*://outlook.office.com/mail/*", "https://outlook.office.com/mail/*", "*://*.office.com/*", "*://forms.office.com/*", "*://forms.microsoft.com/*", "*://outlook.cloud.microsoft/*", "https://outlook.cloud.microsoft/*"],
  require: [
    // 使用具体版本号确保兼容性
    `https://cdn.jsdelivr.net/npm/jquery@3.6.3/dist/jquery.min.js`,
    // TinyMCE is now manually bundled via TinyMCEBundler to bypass CSP
  ],
  grant: ["GM.xmlHttpRequest", "GM_openInTab", "GM_addStyle", "GM_setValue", "GM_getValue", "GM.addElement", "GM_download"],
  connect: ["app.hhaexchange.com", "reports.hhaexchange.com", "outlook.office.com", "outlook.cloud.microsoft", "forms.office.com", "forms.microsoft.com", "unpkg.com"],
